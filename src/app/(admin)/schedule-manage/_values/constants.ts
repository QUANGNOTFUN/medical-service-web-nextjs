import {AdminSchedulesTableProps} from "@/app/(admin)/_components/AdminSchedulesTable/AdminSchedulesTable";

export const HEADER_SCHEDULE_TABLE: AdminSchedulesTableProps['headers'] = [
